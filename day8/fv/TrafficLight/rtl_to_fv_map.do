...
# Generated on: Tue Jun 09 14:30:39 IST 2026 (Tue Jun 09 09:00:39 UTC 2026)
...
set logfile fv/TrafficLight/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/TrafficLight -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/home/install/DDI231/GENUS231/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/install/DDI231/GENUS231/tools.lnx86"
set env(CW_DIR) "/home/install/DDI231/GENUS231/tools.lnx86/lib/chipware"
set CW_DIR      "/home/install/DDI231/GENUS231/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/install/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/install/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/install/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/install/DDI231/GENUS231/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/install/DDI231/GENUS231/tools.lnx86/lib/chipware/sim"
}
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k traffic.v
elaborate_design -golden -root {TrafficLight} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/TrafficLight/fv_map.v.gz
elaborate_design -revised -root {TrafficLight}
...
set_analyze_option -mapping_file fv/TrafficLight/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.TrafficLight.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.TrafficLight.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.TrafficLight.rtl.fv_map.rpt
