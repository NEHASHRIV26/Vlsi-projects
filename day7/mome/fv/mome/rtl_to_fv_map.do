...
# Generated on: Tue Jun 09 10:42:59 IST 2026 (Tue Jun 09 05:12:59 UTC 2026)
...
set logfile fv/mome/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mome -revised fv_map -use_rtl_names
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k mome.v
elaborate_design -golden -root {mome} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/mome/fv_map.v.gz
elaborate_design -revised -root {mome}
...
set_analyze_option -mapping_file fv/mome/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.mome.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mome.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mome.rtl.fv_map.rpt
