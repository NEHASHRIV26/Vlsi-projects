...
# Generated on: Mon Jun 08 13:55:49 IST 2026 (Mon Jun 08 08:25:49 UTC 2026)
...
set logfile fv/count8/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/count8 -revised fv_map -use_rtl_names
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k count8.v
elaborate_design -golden -root {count8} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/count8/fv_map.v.gz
elaborate_design -revised -root {count8}
...
set_analyze_option -mapping_file fv/count8/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.count8.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.count8.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.count8.rtl.fv_map.rpt
