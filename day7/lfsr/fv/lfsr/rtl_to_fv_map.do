...
# Generated on: Mon Jun 08 15:21:15 IST 2026 (Mon Jun 08 09:51:15 UTC 2026)
...
set logfile fv/lfsr/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/lfsr -revised fv_map -use_rtl_names
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k lfsr.v
elaborate_design -golden -root {lfsr} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/lfsr/fv_map.v.gz
elaborate_design -revised -root {lfsr}
...
set_analyze_option -mapping_file fv/lfsr/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.lfsr.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.lfsr.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.lfsr.rtl.fv_map.rpt
