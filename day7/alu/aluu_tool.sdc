...
#  Created by Genus(TM) Synthesis Solution 23.11-s100_1 on Tue Jun 09 09:53:53 IST 2026
...
set_output_delay -clock [get_clocks clk] -add_delay -max 0.4 [get_ports {y[15]}]
set_output_delay -clock [get_clocks clk] -add_delay -max 0.4 [get_ports {y[14]}]
set_output_delay -clock [get_clocks clk] -add_delay -max 0.4 [get_ports {y[13]}]
set_output_delay -clock [get_clocks clk] -add_delay -max 0.4 [get_ports {y[12]}]
set_output_delay -clock [get_clocks clk] -add_delay -max 0.4 [get_ports {y[11]}]
set_output_delay -clock [get_clocks clk] -add_delay -max 0.4 [get_ports {y[10]}]
set_output_delay -clock [get_clocks clk] -add_delay -max 0.4 [get_ports {y[9]}]
set_output_delay -clock [get_clocks clk] -add_delay -max 0.4 [get_ports {y[8]}]
