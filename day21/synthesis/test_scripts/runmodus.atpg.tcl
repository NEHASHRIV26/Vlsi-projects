...
build_model \
    -cell	 count8 \
    -techlib	 /home/install/FOUNDRY/digital/90nm/dig/vlog/slow.v \
    -designsource	 $WORKDIR/count8.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/count8.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 count8_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_count8_atpg
...
check_log log_write_vectors_FULLSCAN_count8_atpg
...
check_log log_commit_tests_FULLSCAN_count8_atpg
gui_open
