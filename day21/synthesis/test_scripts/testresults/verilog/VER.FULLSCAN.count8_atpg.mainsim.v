...
// Modus(TM) DFT Software Solution, Version 22.10-p008_1, built Oct 18 2022  //
//***************************************************************************//
//                                                                           //
//  FILE CREATED..............June 25, 2026 at 14:36:39                      //
//                                                                           //
//  PROJECT NAME..............test_scripts                                   //
//                                                                           //
//  TESTMODE..................FULLSCAN                                       //
//                                                                           //
//  INEXPERIMENT..............count8_atpg                                    //
//                                                                           //
//  TDR.......................dummy.tdr                                      //
//                                                                           //
...
// Command Line: write_vectors -WORKDIR /home/vlsi19/day21/synthesis/test_scripts -TESTMODE FULLSCAN -INEXPERIMENT count8_atpg -STDOUT summary -language verilog -scanformat parallel

  `timescale 1 ns / 1 ps

  module test_scripts_FULLSCAN_count8_atpg ;
...
//***************************************************************************//
  ...
  count8
    count8_inst (
      ...
      .rst      ( part_PIs[3] ),      // pinName = rst;  tf = -SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
      .u_d      ( part_PIs[5] ),      // pinName = u_d; testOffset = 0.000000;  scanOffset = 0.000000;  
      .counter  ({part_POs[8]  ,      // pinName = counter[7]; 
                  part_POs[7]  ,      // pinName = counter[6]; 
                  part_POs[6]  ,      // pinName = counter[5]; 
                  part_POs[5]  ,      // pinName = counter[4]; 
                  part_POs[4]  ,      // pinName = counter[3]; 
                  part_POs[3]  ,      // pinName = counter[2]; 
                  part_POs[2]  ,      // pinName = counter[1]; 
                  part_POs[1]}),      // pinName = counter[0]; 
...
//***************************************************************************//
  ...
  assign ( weak0, weak1 ) // Termination 
    part_POs [1] = global_term,     // pinName = counter[0]; 
    part_POs [2] = global_term,     // pinName = counter[1]; 
    part_POs [3] = global_term,     // pinName = counter[2]; 
    part_POs [4] = global_term,     // pinName = counter[3]; 
    part_POs [5] = global_term,     // pinName = counter[4]; 
    part_POs [6] = global_term,     // pinName = counter[5]; 
    part_POs [7] = global_term,     // pinName = counter[6]; 
    part_POs [8] = global_term,     // pinName = counter[7]; 
    part_POs [9] = global_term;      // pinName = scan_out;  tf =  SO  ; 


  assign ( supply0, supply1 ) // CR = 1 
    count8_inst.scan_in = part_S_CR_1_TM_1 [8] ,   // CR = 1;  pos = 1;  Pin Index = 3;  Pin Name = scan_in;  pinInvFromLatch = no;  Latch Index = 17;  Latch Name = \counter_u_d_reg[0].__iNsT2.dff_primitive;   
    count8_inst.\counter_u_d_reg[1] .SI = part_S_CR_1_TM_1 [7] ,   // CR = 1;  pos = 2;  Pin Index = 97;  Pin Name = \counter_u_d_reg[1].SI;  pinInvFromLatch = no;  Latch Index = 42;  Latch Name = \counter_u_d_reg[1].__iNsT2.dff_primitive;   
    count8_inst.\counter_u_d_reg[2] .SI = part_S_CR_1_TM_1 [6] ,   // CR = 1;  pos = 3;  Pin Index = 176;  Pin Name = \counter_u_d_reg[2].SI;  pinInvFromLatch = no;  Latch Index = 67;  Latch Name = \counter_u_d_reg[2].__iNsT2.dff_primitive;   
    count8_inst.\counter_u_d_reg[3] .SI = part_S_CR_1_TM_1 [5] ,   // CR = 1;  pos = 4;  Pin Index = 255;  Pin Name = \counter_u_d_reg[3].SI;  pinInvFromLatch = no;  Latch Index = 92;  Latch Name = \counter_u_d_reg[3].__iNsT2.dff_primitive;   
    count8_inst.\counter_u_d_reg[4] .SI = part_S_CR_1_TM_1 [4] ,   // CR = 1;  pos = 5;  Pin Index = 334;  Pin Name = \counter_u_d_reg[4].SI;  pinInvFromLatch = no;  Latch Index = 117;  Latch Name = \counter_u_d_reg[4].__iNsT2.dff_primitive;   
    count8_inst.\counter_u_d_reg[5] .SI = part_S_CR_1_TM_1 [3] ,   // CR = 1;  pos = 6;  Pin Index = 413;  Pin Name = \counter_u_d_reg[5].SI;  pinInvFromLatch = no;  Latch Index = 142;  Latch Name = \counter_u_d_reg[5].__iNsT2.dff_primitive;   
    count8_inst.\counter_u_d_reg[6] .SI = part_S_CR_1_TM_1 [2] ,   // CR = 1;  pos = 7;  Pin Index = 492;  Pin Name = \counter_u_d_reg[6].SI;  pinInvFromLatch = no;  Latch Index = 167;  Latch Name = \counter_u_d_reg[6].__iNsT2.dff_primitive;   
    count8_inst.\counter_u_d_reg[7] .SI = part_S_CR_1_TM_1 [1] ;   // CR = 1;  pos = 8;  Pin Index = 571;  Pin Name = \counter_u_d_reg[7].SI;  pinInvFromLatch = no;  Latch Index = 192;  Latch Name = \counter_u_d_reg[7].__iNsT2.dff_primitive;   

  assign // OR = 1 
    part_M_OR_1_TM_1 [1] =  count8_inst.scan_out ,   // OR = 1;  pos = 1;  Pin Index = 13;  Pin Name = scan_out;  pinInvFromLatch = no;  Latch Index = 192;  Latch Name = \counter_u_d_reg[7].__iNsT2.dff_primitive;   
    part_M_OR_1_TM_1 [2] =  count8_inst.\counter_u_d_reg[6] .Q ,   // OR = 1;  pos = 2;  Pin Index = 493;  Pin Name = \counter_u_d_reg[6].Q;  pinInvFromLatch = no;  Latch Index = 167;  Latch Name = \counter_u_d_reg[6].__iNsT2.dff_primitive;   
    part_M_OR_1_TM_1 [3] =  count8_inst.\counter_u_d_reg[5] .Q ,   // OR = 1;  pos = 3;  Pin Index = 414;  Pin Name = \counter_u_d_reg[5].Q;  pinInvFromLatch = no;  Latch Index = 142;  Latch Name = \counter_u_d_reg[5].__iNsT2.dff_primitive;   
    part_M_OR_1_TM_1 [4] =  count8_inst.\counter_u_d_reg[4] .Q ,   // OR = 1;  pos = 4;  Pin Index = 335;  Pin Name = \counter_u_d_reg[4].Q;  pinInvFromLatch = no;  Latch Index = 117;  Latch Name = \counter_u_d_reg[4].__iNsT2.dff_primitive;   
    part_M_OR_1_TM_1 [5] =  count8_inst.\counter_u_d_reg[3] .Q ,   // OR = 1;  pos = 5;  Pin Index = 256;  Pin Name = \counter_u_d_reg[3].Q;  pinInvFromLatch = no;  Latch Index = 92;  Latch Name = \counter_u_d_reg[3].__iNsT2.dff_primitive;   
    part_M_OR_1_TM_1 [6] =  count8_inst.\counter_u_d_reg[2] .Q ,   // OR = 1;  pos = 6;  Pin Index = 177;  Pin Name = \counter_u_d_reg[2].Q;  pinInvFromLatch = no;  Latch Index = 67;  Latch Name = \counter_u_d_reg[2].__iNsT2.dff_primitive;   
    part_M_OR_1_TM_1 [7] =  count8_inst.\counter_u_d_reg[1] .Q ,   // OR = 1;  pos = 7;  Pin Index = 98;  Pin Name = \counter_u_d_reg[1].Q;  pinInvFromLatch = no;  Latch Index = 42;  Latch Name = \counter_u_d_reg[1].__iNsT2.dff_primitive;   
    part_M_OR_1_TM_1 [8] =  count8_inst.\counter_u_d_reg[0] .Q ;   // OR = 1;  pos = 8;  Pin Index = 19;  Pin Name = \counter_u_d_reg[0].Q;  pinInvFromLatch = no;  Latch Index = 17;  Latch Name = \counter_u_d_reg[0].__iNsT2.dff_primitive;   
...
//***************************************************************************//
  ...
  initial 
    begin 
      ...
      `ifdef sdf_annotate 
        `ifdef SDF_Minimum 
          $sdf_annotate ("default.sdf",count8_inst,,"sdf_Min.log","MINIMUM");
        `endif 
        `ifdef SDF_Maximum 
          $sdf_annotate ("default.sdf",count8_inst,,"sdf_Max.log","MAXIMUM");
        `endif 
        `ifdef SDF_Typical
          $sdf_annotate ("default.sdf",count8_inst,,"sdf_Typ.log","TYPICAL");
        `endif 
      `endif 
      ...
      if ( $test$plusargs ( "vcd" ) )  begin 
        $dumpfile("out.vcd"); 
        $dumpvars(0,test_scripts_FULLSCAN_count8_atpg ); 
      end  
...
//***************************************************************************//
  ...
  task sim_setup; 
    begin 
      ...
      count_cycles = 1'b1; 
      SEQNUM = 0; 
      name_POs [1] = "counter[0]";      // pinName = counter[0]; 
      name_POs [2] = "counter[1]";      // pinName = counter[1]; 
      name_POs [3] = "counter[2]";      // pinName = counter[2]; 
      name_POs [4] = "counter[3]";      // pinName = counter[3]; 
      name_POs [5] = "counter[4]";      // pinName = counter[4]; 
      name_POs [6] = "counter[5]";      // pinName = counter[5]; 
      name_POs [7] = "counter[6]";      // pinName = counter[6]; 
      name_POs [8] = "counter[7]";      // pinName = counter[7]; 
...
//***************************************************************************//
  ...
  task sim_vector_file; 
    begin 
      ...
      $display ( "\nINFO (TVE-189): Design:  count8   Test Mode:  FULLSCAN   InExperiment:  count8_atpg " ); 
  ...
  task test_cycle; 
    begin 
     ...
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
      ...
      part_PIs [5] = stim_PIs [5];      // pinName = u_d; testOffset = 0.000000;  scanOffset = 0.000000;  
     ...
     #56.000000;        // 72.000000 ns;  From the start of the cycle.
      ...
      for ( POnum = 1; POnum <= 9; POnum = POnum + 1 ) begin 
        if (( part_POs [ POnum ] !== meas_POs [ POnum ] ) & ( meas_POs [ POnum ] !== 1'bX )) begin 
          ...
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "count8", name_POs [ POnum ], PATTERN, -1, part_POs [ POnum ] ); 
          end  
        end  
     ...
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
      ...
      for ( SCANCYCLE = 1; SCANCYCLE <= MAX; SCANCYCLE = SCANCYCLE + 1 ) begin 
        ...
        if (( part_M_OR_1_TM_1 [ 0 + SCANCYCLE ] !== meas_OR_1 [ 0 + SCANCYCLE ] ) & ( meas_OR_1 [ 0 + SCANCYCLE ] !== 1'bX )) begin      // pinName = scan_out;  tf =  SO  ; 
          ...
          if (( failset ) & ( FAILSETID == 0 ))  failset_setup; 
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "count8", name_POs [9], PATTERN, SCANCYCLE, part_M_OR_1_TM_1 [ 0 + SCANCYCLE ] ); 
          end  
        end  
        else  begin 
      ...
      case ( CMD ) 
        ...
        904: begin 
          ...
          if ( rc_read > 0 )  begin 
            `ifdef MISCOMPAREDEBUG 
              if ( diag_debug ) begin 
                $processSimulationDebugFile ( DIAG_DEBUG_FILE, "count8_inst", eventID ); 
              end 
            `endif 
          end  
          else  bad_cmd_code; 
