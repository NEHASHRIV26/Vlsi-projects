...
# Generated on: Tue Jun 23 09:35:20 IST 2026 (Tue Jun 23 04:05:20 UTC 2026)
...
set logfile fv/booth/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/booth -revised fv_map
...
elaborate_design -golden -root {booth} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/booth/fv_map.v.gz
elaborate_design -revised -root {booth}
...
#add_name_alias fv/booth/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.booth.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.booth.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.booth.rtl.fv_map.rpt
