...
# Generated on: Mon Jun 22 11:06:23 IST 2026 (Mon Jun 22 05:36:23 UTC 2026)
...
set logfile fv/mealy/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mealy -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  mealy.v
elaborate_design -golden -root {mealy} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/mealy/fv_map.v.gz
elaborate_design -revised -root {mealy}
...
#add_name_alias fv/mealy/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.mealy.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mealy.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mealy.rtl.fv_map.rpt
