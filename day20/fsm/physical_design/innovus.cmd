...
#  Created on Mon Jun 22 11:07:56 2026                
#                                                     
#######################################################
...
set init_verilog ../synthesis/mealy_netlist.v
...
saveDesign mealy_POWERPLAN.enc
saveDesign mealy_POWERPLAN.enc
...
place_design
saveDesign mealy_PLACEMENT.enc
saveDesign mealy_PLACEMENT.enc
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -preCTS -pathReports -drvReports -slackReports -numPaths 50 -prefix mealy_preCTS -outDir timingReports
...
zoomSelected
deselectAll
zoomBox 18.96250 30.74800 22.97800 32.70950
uiSetTool select
zoomBox 13.40850 29.00850 25.93750 35.12850
zoomBox -8.33950 22.20650 37.64550 44.66850
zoomBox -75.90500 1.08700 67.54600 71.15700
zoomBox -93.32200 -4.34150 75.44400 78.09350
