...
# Generated on: Thu Jun 18 09:46:26 IST 2026 (Thu Jun 18 04:16:26 UTC 2026)
...
set logfile fv/memory/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/memory -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  memory.v
elaborate_design -golden -root {memory} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/memory/fv_map.v.gz
elaborate_design -revised -root {memory}
...
#add_name_alias fv/memory/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.memory.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.memory.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.memory.rtl.fv_map.rpt
