...
create_analysis_view -name best_corner -constraint_mode sdc -delay_corner min_delay -latency_file ${::IMEX::dataVar}/mmmc/views/best_corner/latency.sdc
create_analysis_view -name worst_case -constraint_mode sdc -delay_corner max_delay -latency_file ${::IMEX::dataVar}/mmmc/views/worst_case/latency.sdc
set_analysis_view -setup [list worst_case] -hold [list best_corner]
