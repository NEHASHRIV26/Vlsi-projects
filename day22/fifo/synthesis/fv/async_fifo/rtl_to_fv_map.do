...
# Generated on: Wed Jul 01 13:12:30 IST 2026 (Wed Jul 01 07:42:30 UTC 2026)
...
set logfile fv/async_fifo/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/async_fifo -revised fv_map
...
read_library -liberty -both \
    /home/vlsi19/45nm_Library/lib/slow_vdd1v0_basicCells.lib
...
elaborate_design -golden -root {async_fifo} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/async_fifo/fv_map.v.gz
elaborate_design -revised -root {async_fifo}
...
#add_name_alias fv/async_fifo/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.async_fifo.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.async_fifo.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.async_fifo.rtl.fv_map.rpt
