...
constraintGroups(
 ...
 ;( -----	---------- )
  ( "virtuosoDefaultExtractorSetup"	nil
    ...
    interconnect(
     ( validLayers   (substrate2 gate polycutoxide resdumcutpoly capmetalcutmetal PWdummy Nwell  Oxide  Poly Nimp Pimp  Cont  Metal1  Via1  Metal2  Via2  Metal3  Via3  Metal4  Via4  Metal5  Via5  Metal6  Via6  Metal7  Via7  Metal8  Via8  Metal9  Via9  Metal10  Via10  Metal11  ) )
    ) ;interconnect
 ...
 ;( -----	---------- )
  ( "foundry"	nil
    ...
    spacings(
     ...
     ( minSpacing                 "ndiff"	"pdiff"		0.1  'coincidentAllowed 'ref  "OXIDE.SP.3"  'description  "Minimum N+ Active Area to P+ Active Area Space" )
     ...
     ( minSpacing                 "Nimp"	"ptap"		0.02 'coincidentAllowed 'ref  "NIMP.SE.2"  'description  "Minimum N+ Implant to P+ Substrate Tie Space" )
     ( minSpacing                 "Pimp"	"ntap"		0.02 'coincidentAllowed 'ref  "PIMP.SE.2"  'description  "Minimum P+ Implant to N+ Active Area Nwell Tie Space" )
...
;  [userFunc userArgs dfmConstrGrp singleContact])
  ...
  (
    (("Nimp" "drawing") "diffusion" 0.07)
    (("Nimp" "drawing") "gate" 0.1)
  )
  "G" "S" "D" (t nil t t t nil nil nil nil nil)
  "distribute" 0.1 _def_ _def_ _def_
  _def_ 0.00 0.03 0.03
  0.03 0.03 "t"
  _def_ _def_ _def_ _def_
  _def_ _def_ 0.1 _def_
  "nmos1" 0.12 0.045 1
  )

  (qpmos1v Poly drawing Metal1 drawing Cont drawing Oxide drawing
  (
    (("Pimp" "drawing") "diffusion" 0.07)
    (("Pimp" "drawing") "gate" 0.1)
    (("Nwell" "drawing") "diffusion" 0.06 "")
  )
  "G" "S" "D" (t nil t t t nil nil nil nil nil)
  "distribute" 0.1 _def_ _def_ _def_
  _def_ 0.00 0.03 0.03
...
tcDeclareDevice( "layout" "cdsGuardRing" "pring"
    ...
    ( (contAlignment "") (yDiffEnclCont 0.030000) (xDiffEnclCont 0.030000) 
      ...
      (enclosingLayers "(((\\\"Pimp\\\" \\\"drawing\\\") 0.0 ?coverInterior nil ?useEncLayer t ?pin nil))") (shapeData "nil") (shapeType "none") 
...
tcDeclareDevice( "layout" "cdsGuardRing" "nring"
    ...
    ( (contAlignment "") (yDiffEnclCont 0.030000) (xDiffEnclCont 0.030000) 
      (yMetEnclCont 0.030000) (xMetEnclCont 0.030000) (yContSpacing 0.080000) 
      (xContSpacing 0.060000) (yContWidth 0.060000) (xContWidth 0.060000) 
      (enclosingLayers "(((\\\"Nimp\\\" \\\"drawing\\\") 0.0 ?coverInterior nil ?useEncLayer t ?pin nil) ((\\\"Nwell\\\" \\\"drawing\\\") 0.09 ?coverInterior nil ?useEncLayer t ?pin nil))") (shapeData "nil") (shapeType "none") 
      (decompositionMode "fill45-path-poly") (hide_keepouts t) (fillStyle "distribute") 
      (fillClass "vfoSfFillSafe") (debug 0) (do_something t) 
      (formalVersion 0) (keepOuts (quote nil)) (removeCornerContacts 
    (quote nil)) )
